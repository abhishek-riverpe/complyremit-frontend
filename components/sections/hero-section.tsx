...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-subtle min-h-150 flex items-center overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 relative z-10">
        <div className="text-center animate-fade-in">
          ...
          <div className="inline-flex items-center gap-2 badge-stripe mb-8 shadow-stripe-sm">
