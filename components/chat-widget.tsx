...
const SUGGESTIONS = [
  "What is ComplyRemit?",
  "How much can I save on wire transfers?",
  "What is invoice lending?",
...
export function ChatWidget() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      appendToMessage(
        assistantId,
        "Sorry, I encountered an error. Please try again or contact sales@complyremit.com for help.",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="relative flex flex-col w-full h-full bg-background md:w-105 md:h-150 md:rounded-2xl md:border md:border-border md:shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-background">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-sm font-semibold">ComplyRemit Assistant</h2>
                  <p className="text-xs text-muted-foreground">
                    Ask anything about ComplyRemit
                  </p>
                </div>
              </div>
              ...
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Ask me about fees, features, or how ComplyRemit works.
                  </p>
              ...
              <form onSubmit={handleSubmit}>
                <div className="relative flex items-end gap-2 rounded-2xl border border-border bg-card p-2 focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary/50 transition-all">
                  <textarea
                    ...
                    placeholder="Ask about ComplyRemit..."
                    rows={1}
