...
function HeroSection() {
    const [transactionCount, setTransactionCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(127643);
...
"[project]/components/sections/waitlist-section.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"]({
    fullName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"]().required("Full name is required").min(2, "Name must be at least 2 characters"),
    ...
    whatsapp: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"]().required("WhatsApp number is required").min(10, "Please enter a valid phone number"),
    message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"]().required("Message is required").min(10, "Message must be at least 10 characters").max(2000, "Message must be at most 2000 characters")
});
const features = [
    {
...
function WaitlistSection() {
    ...
    const onSubmit = async (data)=>{
        ...
        setIsSuccess(false);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/contact", {
                ...data,
                "source": "COMPLYREMIT"
            });
            setIsSuccess(true);
            ...
            setIsError(true);
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAxiosError(error) && error.response?.data?.error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__57769cb0._.js.map